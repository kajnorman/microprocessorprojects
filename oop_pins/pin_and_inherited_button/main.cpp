...
int main(void)
{
	Button startbutton = Button(B,5,0);  //sets PORTB.5 to be an input (last argument 1 for out 0 for in)
	...
	PORTPin redled = PORTPin(D,1,1);  //sets PORTD.1 to be an output (last argument 1 for out 0 for in)
